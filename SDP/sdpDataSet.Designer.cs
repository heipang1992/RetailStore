...
namespace SDP {
    ...
    public partial class sdpDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            private global::System.Data.DataColumn columnproductCategeory;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public global::System.Data.DataColumn productCategeoryColumn {
                get {
                    return this.columnproductCategeory;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductRow AddProductRow(int supplierID, string productCategeory, string productName, string model, decimal price, int quantity) {
            ...
            internal void InitVars() {
                ...
                this.columnproductCategeory = base.Columns["productCategeory"];
            ...
            private void InitClass() {
                ...
                this.columnproductCategeory = new global::System.Data.DataColumn("productCategeory", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnproductCategeory);
                ...
                this.columnproductCategeory.AllowDBNull = false;
                this.columnproductCategeory.MaxLength = 50;
        ...
        public partial class ProductRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public string productCategeory {
                get {
                    return ((string)(this[this.tableProduct.productCategeoryColumn]));
                }
                set {
                    this[this.tableProduct.productCategeoryColumn] = value;
                }
            }
...
namespace SDP.sdpDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("productCategeory", "productCategeory");
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Product` WHERE ((`productID` = @p1) AND (`supplierID` = @p2) AND (`p" +
                "roductCategeory` = @p3) AND (`productName` = @p4) AND (`model` = @p5) AND (`pric" +
                "e` = @p6) AND (`quantity` = @p7))";
            ...
            param.IsNullable = true;
            param.SourceColumn = "productCategeory";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Product` (`supplierID`, `productCategeory`, `productName`, `model`, " +
                "`price`, `quantity`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Product` SET `supplierID` = @p1, `productCategeory` = @p2, `productName` = @p3, `model` = @p4, `price` = @p5, `quantity` = @p6 WHERE ((`productID` = @p7) AND (`supplierID` = @p8) AND (`productCategeory` = @p9) AND (`productName` = @p10) AND (`model` = @p11) AND (`price` = @p12) AND (`quantity` = @p13))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SDP.Properties.Settings.Default.sdpConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `productID`, `supplierID`, `productCategeory`, `productName`, `model`, `pr" +
                "ice`, `quantity` FROM `Product`";
        ...
        public virtual int Delete(int p1, int p2, string p3, string p4, string p5, decimal p6, int p7) {
        ...
        public virtual int Insert(int p1, string p2, string p3, string p4, decimal p5, int p6) {
        ...
        public virtual int Update(int p1, string p2, string p3, string p4, decimal p5, int p6, int p7, int p8, string p9, string p10, string p11, decimal p12, int p13) {
