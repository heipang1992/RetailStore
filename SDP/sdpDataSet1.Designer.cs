...
namespace SDP {
    ...
    public partial class sdpDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/sdpDataSet1.xsd";
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductRow AddProductRow(int supplierID, decimal price, int quantity) {
...
namespace SDP.sdpDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Product` SET `supplierID` = @p1, `price` = @p2, `quantity` = @p3 WHERE ((" +
                "`productID` = @p4) AND (`supplierID` = @p5) AND (`price` = @p6) AND (`quantity` " +
                "= @p7))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `productID`, `supplierID`, `price`, `quantity` FROM `Product`";
        ...
        public virtual int Update(int p1, decimal p2, int p3, int p4, int p5, decimal p6, int p7) {
